...
#ifndef TIPICL_SMSG_SMESSAGE_H
#define TIPICL_SMSG_SMESSAGE_H
...
const unsigned int SMSG_MAX_MSG_BYTES  = 24000;             // the user input tip
const unsigned int SMSG_MAX_AMSG_BYTES = 512;               // the user input tip (ANON)
const unsigned int SMSG_MAX_MSG_BYTES_PAID = 512 * 1024;    // the user input tip (Paid)
