...
static const uint8_t TIPICL_BLOCK_VERSION = 0xA0;
static const uint8_t TIPICL_TXN_VERSION = 0xA0;
static const uint8_t MAX_TIPICL_TXN_VERSION = 0xBF;
...
inline bool IsTipStreamTxVersion(int nVersion)
{
    return (nVersion & 0xFF) >= TIPICL_TXN_VERSION;
}
...
inline void SerializeTransaction(const TxType& tx, Stream& s) {
    ...
    if (IsTipStreamTxVersion(tx.nVersion)) {
...
public:
    ...
    static const int32_t CURRENT_TIPICL_VERSION=0xA0;
    ...
    static const int32_t MAX_STANDARD_TIPICL_VERSION=0xA0;
...
public:
    ...
    bool IsTipStreamVersion() const {
        return IsTipStreamTxVersion(nVersion);
    }
    ...
    {
        return IsTipStreamTxVersion(nVersion) ? vpout.size() : vout.size();
    }
