...
BOOST_FIXTURE_TEST_SUITE(tipstreamchain_tests, TipStreamBasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(signature_test)
{
    ...
    CMutableTransaction txn;
    txn.nVersion = TIPICL_TXN_VERSION;
    txn.nLockTime = 0;
    ...
    txn2.nVersion = TIPICL_TXN_VERSION;
...
BOOST_AUTO_TEST_CASE(tipstreamchain_test)
{
    SeedInsecureRand();
    CBasicKeyStore keystore;
    ...
    CBlock blk;
    blk.nVersion = TIPICL_BLOCK_VERSION;
    blk.nTime = 1487406900;
    ...
    txnSpend.nVersion = TIPICL_BLOCK_VERSION;
}
...
BOOST_AUTO_TEST_CASE(mixed_input_types)
{
    CMutableTransaction txn;
    txn.nVersion = TIPICL_TXN_VERSION;
    BOOST_CHECK(txn.IsTipStreamVersion());
    ...
    txnPrev.nVersion = TIPICL_TXN_VERSION;
    BOOST_CHECK(txnPrev.IsTipStreamVersion());
