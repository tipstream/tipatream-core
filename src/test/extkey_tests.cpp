...
BOOST_FIXTURE_TEST_SUITE(extkey_tests, TipStreamBasicTestingSetup)
    ...
    */
    ...
    std::vector<DeriveTestData> vMainNetPairs = {
        DeriveTestData(0,
            ...
            std::string("PTIPKMMf4AUDYzRSBcXSJZALbUXgWKHi6qdpy95yBmABuznU3keHFyNHfjaMT33ehuYwjx3RXort1j8d9AYnqyhAvdN168J4GBsM2ZHuTb91rsj")),
        DeriveTestData(1,
            ...
            std::string("PTIPKPL4rp5WLnrYRpBPySBKNwQbcNxtP22g5PYFeVLri914xwnzewmxBH4dTMd6Xf578bi3sUnLpix65m2gENpWRdwGM5L7fM4Q4FU5StZaV2D")),
        ...
        DeriveTestData(350,
            ...
            std::string("PTIPNRKDEts7sZSjXXzgDkbHy6waPumHqBAqiTPJsLW4R87st4ibXFs3a9vi3uVdvy14rJQxqfKLKuqnVZboDCadnzgRR1TicCxDYke1jRB4hUk")),
    };
    ...
    std::vector<DeriveTestData> vTestNetPairs = {
        ...
        DeriveTestData(350,
            ...
            std::string("ptip3HanNi1z5VK7EMYkZXbgHi6i1BV8PozsnKm7bCjnA8xhj7wLJ5s4JBdodEmyCwRnwiSe66qx4fej5nkKTDioEGwKn1qoyJccJwDSBXEsZmM")),
    };
    CBitcoinExtKey extKey58;
...
void RunSerialiseTests()
{
    ...
    BOOST_CHECK(eKey58.ToString() == "PTIPKMMf4AUDYzRSBcXSJZALbUXgWKHi6qdpy95yBmABuznU3keHFyNHfjaMT33ehuYwjx3RXort1j8d9AYnqyhAvdN168J4GBsM2ZHuTb91rsj");
    ...
    BOOST_CHECK(0 == eKey58.Set58("PTIPKMMf4AUDYzRSBcXSJZALbUXgWKHi6qdpy95yBmABuznU3keHFyNHfjaMT33ehuYwjx3RXort1j8d9AYnqyhAvdN168J4GBsM2ZHuTb91rsj"));
    kp = eKey58.GetKey();
    ...
    BOOST_CHECK(addr.ToString() == "PTIPKMMf4AUDYzRSBcXSJZALbUXgWKHi6qdpy95yBmABuznU3keHFyNHfjaMT33ehuYwjx3RXort1j8d9AYnqyhAvdN168J4GBsM2ZHuTb91rsj");
    dest = addr.Get();
