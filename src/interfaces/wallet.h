...
public:
    ...
    //! Try to get updated status for a tipicular transaction, if possible without blocking.
    ...
    virtual bool IsTipStreamWallet() = 0;
    ...
    virtual CHDWallet *getTipStreamWallet() = 0;
