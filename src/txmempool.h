 ...
 * in-mempool children is false.  In tipicular, the mempool is in an
 ...
 * until this is called, the mempool state is not consistent, and in tipicular
...
public:
     ...
     * fix for third tipy code that needs be able to frequently poll the
