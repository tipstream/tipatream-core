...
#ifndef TIPICL_WALLET_HDWALLET_H
#define TIPICL_WALLET_HDWALLET_H
...
public:
    void Clear()
    {
        ...
        nTipImmature = 0;
        nTipWatchOnly = 0;
        nTipWatchOnlyUnconf = 0;
        nTipWatchOnlyStaked = 0;
    ...
    CAmount nTip = 0;
    CAmount nTipUnconf = 0;
    CAmount nTipStaked = 0;
    CAmount nTipImmature = 0;
    CAmount nTipWatchOnly = 0;
    CAmount nTipWatchOnlyUnconf = 0;
    CAmount nTipWatchOnlyStaked = 0;
...
#endif // TIPICL_WALLET_HDWALLET_H
