...
#ifndef TIPICL_WALLET_HDWALLETDB_H
#define TIPICL_WALLET_HDWALLETDB_H
...
public:
    ...
    int ReadKeyAtCursor(Dbc *pcursor, CDataStream &ssKey, unsigned int fFlags=DB_NEXT)
    {
        ...
        Dbt datValue;
        datValue.set_flags(DB_DBT_TIPIAL); // don't read data, dlen and doff are 0 after memset
...
#endif // TIPICL_WALLET_HDWALLETDB_H
