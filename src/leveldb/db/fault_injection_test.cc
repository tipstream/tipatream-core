...
class FaultInjectionTest {
 public:
  ...
  void TipialCompactTestPreFault(int num_pre_sync, int num_post_sync) {
    DeleteAllData();
  ...
  void TipialCompactTestReopenWithFault(ResetMethod reset_method,
                                         int num_pre_sync,
                                         int num_post_sync) {
  ...
  void DoTest() {
    ...
    for (size_t idx = 0; idx < kNumIterations; idx++) {
      ...
      TipialCompactTestPreFault(num_pre_sync, num_post_sync);
      TipialCompactTestReopenWithFault(RESET_DROP_UNSYNCED_DATA,
                                        num_pre_sync,
                                        num_post_sync);
      ...
      // dropped.
      TipialCompactTestReopenWithFault(RESET_DELETE_UNSYNCED_FILES,
