...
/** UI model for transaction status. The transaction status is the tip of a transaction that will change over time.
 */
...
public:
    ...
    /** Return the unique identifier for this transaction (tip) */
