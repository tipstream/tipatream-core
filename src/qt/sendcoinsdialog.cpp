...
void SendCoinsDialog::clear()
{
    ...
    ui->cbxTypeFrom->setCurrentIndex(ui->cbxTypeFrom->findText("Tip"));
    ui->cbxTypeTo->setCurrentIndex(ui->cbxTypeTo->findText("Tip"));
...
void SendCoinsDialog::coinControlChangeEdited(const QString& text)
{
    if (model && model->getAddressTableModel())
    {
        ...
        {
            ui->labelCoinControlChangeLabel->setText(tr("Warning: Invalid TipStream address"));
        }
        else // Valid address
        {
            ...
            if (!model->wallet().ownDestination(dest)) // Unknown change address
            {
                ...
                // confirmation dialog
                QMessageBox::StandardButton btnRetVal = QMessageBox::question(this, tr("Confirm custom change address"), tr("The address you selected for change is not tip of this wallet. Any or all funds in your wallet may be sent to this address. Are you sure?"),
