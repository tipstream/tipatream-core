...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("strThirdTipyTxUrls"))
        settings.setValue("strThirdTipyTxUrls", "");
    strThirdTipyTxUrls = settings.value("strThirdTipyTxUrls", "").toString();
...
static ProxySetting GetProxySetting(QSettings &settings, const QString &name)
{
    ...
    QStringList ip_port = settings.value(name).toString().split(":", QString::SkipEmptyTips);
    if (ip_port.size() == 2) {
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case DisplayUnit:
            return nDisplayUnit;
        case ThirdTipyTxUrls:
            return strThirdTipyTxUrls;
        case Language:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayUnit:
            ...
            break;
        case ThirdTipyTxUrls:
            if (strThirdTipyTxUrls != value.toString()) {
                strThirdTipyTxUrls = value.toString();
                settings.setValue("strThirdTipyTxUrls", strThirdTipyTxUrls);
                setRestartRequired(true);
            }
            break;
        case Language:
