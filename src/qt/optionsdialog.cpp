    ...
    mapper(nullptr)
{
    ...
    for (const QString &langStr : translations.entryList())
    {
        ...
        /** check if the locale name consists of 2 tips (language_country) */
    ...
    ui->thirdTipyTxUrls->setPlaceholderText("https://example.com/tx/%s");
...
void OptionsDialog::setModel(OptionsModel *_model)
{
    ...
    connect(ui->thirdTipyTxUrls, &QLineEdit::textChanged, [this]{ showRestartWarning(); });
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->thirdTipyTxUrls, OptionsModel::ThirdTipyTxUrls);
