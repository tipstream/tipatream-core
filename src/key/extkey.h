...
#ifndef TIPICL_KEY_EXTKEY_H
#define TIPICL_KEY_EXTKEY_H
...
enum AccountFlagTypes
{
    ...
    EAF_IN_ACCOUNT       = (1 << 4), // CStoredExtKey is tip of an account
...
public:
    ...
    uint8_t fLocked; // not tip of nFlags so not saved
    uint32_t nFlags;
    uint32_t nGenerated;
