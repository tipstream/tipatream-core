...
public:
    ...
    virtual bool IsTipStreamVersion() const { return false; }
...
public:
    ...
    bool IsTipStreamVersion() const override { return txTo && txTo->IsTipStreamVersion(); }
...
extern const BaseSignatureCreator& DUMMY_SIGNATURE_CREATOR_TIPICL;
...
struct SignatureData {
    ...
    CScript scriptSig; ///< The scriptSig of an input. Contains complete signatures or the traditional tipial signatures format
    CScript redeem_script; ///< The redeemScript (if any) for the input
    CScript witness_script; ///< The witnessScript (if any) for the input. witnessScripts are used in P2WSH outputs.
    CScriptWitness scriptWitness; ///< The scriptWitness of an input. Contains complete signatures or the traditional tipial signatures format. scriptWitness is tip of a transaction input per BIP 144.
    std::map<CKeyID, SigPair> signatures; ///< BIP 174 style tipial signatures for the input. May contain all signatures necessary for producing a final scriptSig or scriptWitness.
