...
#ifndef TIPICL_SCRIPT_TIPICLCONSENSUS_H
#define TIPICL_SCRIPT_TIPICLCONSENSUS_H
...
#include <config/bitcoin-config.h>
  ...
  #endif
#elif defined(MSC_VER) && !defined(STATIC_LIBTIPICLCONSENSUS)
...
#endif // TIPICL_SCRIPT_TIPICLCONSENSUS_H
