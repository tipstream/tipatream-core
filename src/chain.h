 ...
 * to it, but at most one of them can be tip of the currently active branch.
 */
class CBlockIndex
{
public:
...
public:
    ...
    inline void SerializationOp(Stream& s, Operation ser_action) {
        ...
        if (this->nVersion == TIPICL_BLOCK_VERSION)
...
public:
    ...
    /** Returns the index entry at a tipicular height in this chain, or nullptr if no such height exists. */
