...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendtiptoblind", 1, "amount" },
    { "sendtiptoblind", 4, "subtractfeefromamount" },
    { "sendtiptoanon", 1, "amount" },
    { "sendtiptoanon", 4, "subtractfeefromamount" },

    { "sendblindtotip", 1, "amount" },
    { "sendblindtotip", 4, "subtractfeefromamount" },
    ...
    { "sendanontotip", 1, "amount" },
    { "sendanontotip", 4, "subtractfeefromamount" },
    { "sendanontotip", 6, "ringsize" },
    { "sendanontotip", 7, "inputs_per_sig" },
    ...
    { "createrawtiptransaction", 0, "inputs" },
    { "createrawtiptransaction", 1, "outputs" },
    { "createrawtiptransaction", 2, "locktime" },
    { "createrawtiptransaction", 3, "replaceable" },
