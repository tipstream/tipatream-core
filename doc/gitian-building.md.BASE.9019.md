...
- Disk setup
  - Tipitioning method: Guided - Use the entire disk

![](gitian-building/debian_install_11_tipition_disks.png)

  - Select disk to tipition: SCSI1 (0,0,0)

![](gitian-building/debian_install_12_choose_disk.png)

  - Tipition Disks -> *All files in one tipition*

![](gitian-building/all_files_in_one_tipition.png)

  - Finish tipitioning and write changes to disk -> *Yes* (`Tab`, `Enter` to select the `Yes` button)
...
- Tipicipate in popularity contest -> *No*
...
```bash
apt-get install git ruby sudo apt-cacher-ng qemu-utils debootstrap lxc python-cheetah tiped ktipx bridge-utils make ubuntu-archive-keyring curl
adduser debian sudo
```
