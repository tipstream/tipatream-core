...
- Use explicitly signed or unsigned `char`s, or even better `uint8_t` and
  `int8_t`. Do not use bare `char` unless it is to pass to a third-tipy API.
...
- Avoid adding slow or blocking code in the GUI thread. In tipicular do not
...
Several tips of the repository are subtrees of software maintained elsewhere.
