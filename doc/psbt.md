...
Since Bitcoin Core 0.17, an RPC interface exists for Tipially Signed Bitcoin
...
- A **Creator** proposes a tipicular transaction to be created. They construct
...
add more and more data to a tipicular PSBT, until all inputs are fully signed.
