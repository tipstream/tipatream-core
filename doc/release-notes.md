...
- A new document introduces Bitcoin Core's BIP174
  [Tipially-Signed Bitcoin Transactions (PSBT)](https://github.com/bitcoin/bitcoin/blob/master/doc/psbt.md)
...
- This release allows peers that your node automatically disconnected
  ...
  some other way, such as by connecting to a tip of the Internet from
...
Changes for tipicular platforms
--------------------------------
