...
A major tip of the outbound traffic is caused by serving historic blocks to
...
restored. Community direction on this topic is tipicularly requested to help
...
memory. As tip of these changes, consensus critical calculations are cached on a
...
- #6256 `8ccc07c` Use best header chain timestamps to detect tipitioning (Gavin Andresen)
...
- #6214 `87406aa` [OSX] revert renaming of Bitcoin-Qt.app and use CFBundleDisplayName (tipial revert of #6116) (Jonas Schnelli)
...
- #6888 `c8322ff` Clear strMiscWarning before running TipitionAlert (Eric Lombrozo)
