...
Note, Legacy Stealth Addresses are not supported on Hardware Signing Devices. If you have TIP/tTIP received on the Legacy Stealth Addresses then we suggest you send those TIP/tTIP to a non-Stealth Address before attempting to use with the Hardware Signing Devices.
...
GUI changes
-----------
- Uses of "µTIP" in the GUI now also show the more colloquial term "tips", specified in BIP176.
...
- #12035 `eeb6d52` Change µTIP to bits (jb55)
