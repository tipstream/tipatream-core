...
class ZMQTest(TipStreamTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that tipstream has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("tipstreamd has not been built with zmq enabled.")
    ...
    def _zmq_test(self):
        ...
        for count in range(0, 100):
            try:
                msg = self.zmqSubSocket.recv_multitip(self.zmq.NOBLOCK)
