...
class USBDeviceTest(TipStreamTestFramework):
    ...
    def run_test(self):
        ...
        # Check that tipstream has been built with USB device enabled
        ...
        if not config["components"].getboolean("ENABLE_USBDEVICE"):
            raise SkipTest("tipstreamd has not been built with usb device enabled.")
