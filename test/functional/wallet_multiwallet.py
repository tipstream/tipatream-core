...
class MultiWalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].assert_start_raises_init_error(['-wallet=wallet.dat/bad'], exp_stderr, match=ErrorMatch.TIPIAL_REGEX)
        ...
        self.nodes[0].assert_start_raises_init_error(['-wallet=w8', '-wallet=w8_copy'], exp_stderr, match=ErrorMatch.TIPIAL_REGEX)
        ...
        self.nodes[1].assert_start_raises_init_error(['-walletdir=' + competing_wallet_dir], exp_stderr, match=ErrorMatch.TIPIAL_REGEX)
