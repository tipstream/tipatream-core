...
from test_framework.test_tipstream import TipStreamTestFramework, isclose
from test_framework.util import connect_nodes_bi
from test_framework.authproxy import JSONRPCException


class BlindTest(TipStreamTestFramework):
    ...
    def run_test(self):
        ...
        txnHash = nodes[0].sendtiptoblind(sxAddrTo1_1, 3.4, '', '', False, 'node0 -> node1 p->b')
        ...
        txnHash4 = nodes[1].sendblindtotip(sxAddrTo2_1, 0.5, '', '', False, 'node1 -> node2 b->p')
        ...
        txnHash5 = nodes[0].sendtiptoblind(sxAddrTo2_3, 0.5, '', '', False, 'node0 -> node2 p->b')
        ...
        ro = nodes[1].sendtypeto('blind', 'tip', outputs, 'comment_to', 'comment_from', 4, 64, True)
        ...
        ro = nodes[1].sendtypeto('blind', 'tip', outputs)
        ...
        ro = nodes[0].sendtypeto('tip', 'blind', outputs)
