...
def keyhash_to_p2pkh_tip(b):
    return keyhash_to_p2pkh(b, False, False)


class ColdStakingTest(TipStreamTestFramework):
    ...
    def run_test(self):
        ...
        assert(ro[0] == keyhash_to_p2pkh_tip(hex_str_to_bytes(hashCoinstake)))
        ...
        assert(ro[0] == keyhash_to_p2pkh_tip(hex_str_to_bytes(hashSpend)))
        ...
        txid = nodes[0].sendtypeto('tip', 'blind', outputs, 'comment', 'comment-to', 4, 64, False, coincontrol)
