...
class CBlockHeader:
    __slots__ = ("hash", "hashMerkleRoot", "hashPrevBlock", "nBits", "nNonce",
                 ...
                 "is_tip", "hashWitnessMerkleRoot")

    def __init__(self, header=None, is_tip=False):
        self.is_tip = is_tip
        if header is None:
            self.set_null()
        else:
            self.is_tip = header.is_tip
...
class CTipialMerkleTree:
    ...
    def __repr__(self):
        return "CTipialMerkleTree(nTransactions=%d, vHash=%s, vBits=%s)" % (self.nTransactions, repr(self.vHash), repr(self.vBits))
